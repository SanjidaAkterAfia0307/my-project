...
const Que = () => {
    return (
        <div className='md:m-24'>
            ...
            <div  >
                <div className='shadow-md md:p-12 p-4'>
                    <h4 className='text-slate-800 text-center m-4 font-bold md:text-4xl text-xl'>How does react work</h4>
                ...
                <div className='shadow-md md:p-12 p-4'>
                    <h4 className='text-slate-800 text-center m-4 font-bold md:text-4xl text-xl'>What is the use of useeffect react hooks</h4>
                ...
                <div className='shadow-md md:p-12 p-4'>
                    <h4 className='text-slate-800 text-center m-4 font-bold md:text-4xl text-xl'>Difference between State and Props</h4>
